<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="SatisUygulamaASP.Login.Login" %>
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" runat="server">
				...
				<div class="wrap-input100 validate-input m-b-20" data-validate="Enter username or email">
				  <asp:TextBox ID="TxtKullanici" runat="server" CssClass="input100" placeholder="Kullanıcı Adınız"></asp:TextBox>
